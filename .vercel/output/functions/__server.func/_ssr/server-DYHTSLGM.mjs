...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-DYHTSLGM.js
var server_DYHTSLGM_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BX0BUtXE.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BN8dzdVf.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_DYHTSLGM_exports as t };
